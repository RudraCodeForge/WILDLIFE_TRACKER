    ...
    <div className={`bg-dark ${styles.AboutUs}`}>
      ...
      <div className={styles.AboutUsContent}>
        ...
        <p className={styles.Desc}>
          ...
          nature through technology. Our mission is simple – make it easier for
          everyone to observe, understand, and protect wildlife. What started as
          an idea is now a growing community working together for conservation.
        </p>
      </div>
      <div className={styles.AboutUsContent}>
        ...
        <p className={styles.Desc}>
          ...
          wildlife observation and conservation accessible to everyone.
          A unique team where human passion meets AI support, working side by side to protect wildlife.
        </p>
      ...
      <div className={styles.AboutUsContent}>
        ...
        <p className={styles.Desc}>
          ...
          <li>
            🌱 Future Generations – Spreading awareness to ensure that wildlife
            and natural habitats thrive for years to come.
          </li>
        </p>
      </div>
